//
//  CreateWebllinkNDEFViewController.m
//  SampleNFCObjC
//
...
@interface CreateWebllinkNDEFViewController ()
...
@implementation CreateWebllinkNDEFViewController
...
- (void)initNavigation {
    ...
    self.navigationItem.title = @"WebLink";
